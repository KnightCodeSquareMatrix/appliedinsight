...
const MESSAGES = {
  en: {
    ...
    templates: {
      ...
      durabilityItemsDesc: "Items with minecraft:enchantable/durability tag, or max_damage / damage durability components (not attack damage).",
      ores: "Ores",
  ...
  zh: {
    ...
    templates: {
      ...
      durabilityItemsDesc: "带有 minecraft:enchantable/durability 标签，或含 max_damage / damage 耐久组件的物品（非攻击力）。",
      ores: "矿石",
